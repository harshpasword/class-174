AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    electronGroup.setAttribute("rotation", {x:0, Y:0 ,z:electroneAngle}) 
    electroneAngle += 65;
    ...
    onbeforeprint.appendChild(electronGroup);    
    
    var electron = document.createElement("a-entity");
    electron.setAttribute("id", `electron-${elementName}`);
    electron.setAttribute("geometry", {primitive: "speher", radius: 0.02});
